 ...
 */
final class Version20181017225815 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE donation DROP INDEX UNIQ_31E581A07E9E4C8C, ADD INDEX IDX_31E581A07E9E4C8C (photo_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE donation DROP INDEX IDX_31E581A07E9E4C8C, ADD UNIQUE INDEX UNIQ_31E581A07E9E4C8C (photo_id)');
        $this->addSql('ALTER TABLE donation CHANGE photo_id photo_id INT DEFAULT NULL');
